...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <?php
           ...
           // $bp_id = $_POST['mem_no'];
            ...
            $points = $_POST['points'];
                ...
                $query = "INSERT INTO xcel_member (xcel_id,firstname,lastname,initial,yearlevel,cityadd,homeadd,contactnumber,emailadd,bday,sports,skills,points) 
                VALUES('$xcel_id','$lastname','$firstname','$initial','$yearlevel','$cityadd','$homeadd','$contactnumber','$emailadd','$bday','$sports','$skills','$points')";
        ...
        <?php
            ...
            $query = "SELECT mem_no, xcel_id, lastname, firstname, yearlevel, points FROM xcel_member LIMIT $start_from, $num_rec_per_page";
            $result = mysql_query($query);

            $query1 = "SELECT mem_no, xcel_id, lastname, firstname, yearlevel, points FROM xcel_member";
