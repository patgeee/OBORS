...
<head>
    ...
    <title>OBO Record System | Delete </title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="header">
                                    <h4 class="title text-center">Record of <b> <?php echo $last_name; ?>, <?php echo $first_name; ?> </b> will be Deleted.<br>
                                </div>
                                <hr>
                                <form name="submit" action="delete-notif.php" method="POST">
                                    <input type="hidden" class="form-control" name="id" value="<?php echo $id; ?>">
                                    <input type="hidden" class="form-control" name="last_name" value="<?php echo $last_name; ?>">    
                                    <input type="hidden" class="form-control" name="first_name" value="<?php echo $first_name; ?>">
                                    <div class="places-buttons">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-md-offset-0">
                                                <a href="user_accts.php" class="btn btn-info btn-block">CANCEL</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>    
