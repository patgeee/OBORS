...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <?php
            ...
            $applicant_id = $_POST['mem_no'];
         //   $lastname = $_POST['lastname'];

            $query = "START TRANSACTION;
            INSERT INTO xcel_member_archived SELECT * FROM xcel_member WHERE mem_no='$applicant_id';
            DELETE FROM xcel_member WHERE mem_no='$applicant_id';
            COMMIT;";
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="header">
                                    <h4 class="title text-center">Record  has been moved to archive.<br>
                                </div>
                                <hr>
    ...
    <script type="text/javascript"> 
        $(document).ready(function(){
            ...
            $.notify({
                icon: 'fa fa-check',
                message: "Record has been moved to archive successfully."
            },{
                type: 'info',
                timer: 4000
            });  
