...
{
 $sql_query="DELETE FROM task WHERE task_id=".$_GET['delete_id'];
...
<head>
    ...
    <!--     sript for notifying when deleting/updating     -->
   <script type="text/javascript">
        function edt_id(id)
        {
            if(confirm('Sure to edit ?'))
            {
                window.location.href='edit_task.php?edit_id='+id;
            }
        }
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card ">
                            <div class="header">
                                <h4 class="title">Tasks</h4><th colspan="5">
                                <div><a href="add_task.php"><i class="fa fa-plus-circle" aria-hidden="true" align="right"></i>add task</a> </th>
                                                        ...
                                                        echo "<tr>
                                                            ...
                                                            <td class=\"td-actions text-right\">
                                                                <button type=\"button\" rel=\"tooltip\" title=\"Edit Task\" class=\"btn btn-info btn-simple btn-xs\">
                                                                    <a href=\"javascript:edt_id($row[0])\"><i class=\"fa fa-edit\"></i></a>
                                                                </button>
                                                                <button type=\"button\" rel=\"tooltip\" title=\"Remove\" class=\"btn btn-danger btn-simple btn-xs\">
                                                                    <a href=\"javascript:delete_id($row[0])\"><i class=\"fa fa-times\"></i></a>
                                                                </button>
                                                            </td>
                                                        </tr>";
