                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="header">
                                    <h4 class="title text-center">Record of <b><?php echo $lastname;?></b> will be move to archive.<br>
                                </div>
                                <hr>
                                <form name="submit" action="archive-notif.php" method="POST">
                                    ...
                                    <input type="hidden" class="form-control" name="mem_no" value="<?php echo $mem_no; ?>">    
