...
if(isset($_POST['btn-save']))
{
 ...
 $sql_query = "INSERT INTO task(task) VALUES('$task')";
 // sql query for inserting data into database
                            ...
                            <div class="header">
                                ...
                                <div class="content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                               <button type="submit" name="btn-save" class="btn btn-primary button-loading"><strong>UPDATE</strong></button>
                                            </div>
                                        </div>
