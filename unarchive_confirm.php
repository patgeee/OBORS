        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">ARCHIVED RECORDS | MOVE BACK TO DATABASE</a>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="content">
                                <div class="header">
                                    <h4 class="title text-center">Record of <b><?php echo $lastname;?></b> will be move back to the database.<br>
                                </div>
                                <hr>
                                
                                <form name="submit" action="unarchive-notif.php" method="POST">
                                    ...
                                    <div class="places-buttons">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-md-offset-0">
                                                <a href="archive.php" class="btn btn-info btn-block">CANCEL</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>    
