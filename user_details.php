...
<head>
    ...
    <title>OBO Record System | Record Details: <?php echo $applicant;?></title>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">DATABASE | VIEW RECORD</a>
                </div>
           ...
           // $query = "SELECT * FROM bp_applicant WHERE id = '$view_id';";
